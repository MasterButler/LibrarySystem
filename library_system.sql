...
CREATE TABLE `library_system`.`users` (
  ...
  `user_middlename` VARCHAR(45) NOT NULL DEFAULT ' ',
...
CREATE TABLE `library_system`.`reservable_authors` (
  ...
  `author_middlename` VARCHAR(45) NOT NULL DEFAULT ' ',
...
VALUES 	(1, 'Melville', 'Herman', ' '),
		...
		(7, 'Julian', 'Shun', ' '),
		(8, 'Adler', 'Micah', ' '),
		(9, 'Mitzenmacher', 'Michael', ' '),
		(10, 'Mundie', 'Craig', ' '),
		(11, 'Social Computing Research Group', ' ', ' '),
		(12, 'Shin', 'Yunhee', ' '),
		(13, 'Kim', 'Eun', 'Yi'),
		(14, 'Mottelson', 'Aske', ' '),
		(15, 'Hornbaek', 'Kasper', ' '),
		(16, 'The League for Programming Freedom', ' ', ' '),
		(17, 'Serrano', 'Manuel', ' '),
		(18, 'Prunet', 'Vincent', ' '),
		(19, 'Matsuzawa', 'Tetsuro', ' '),
		(20, 'Weiss', 'Ron', ' '),
		(21, 'Moore', 'Jason', 'H.'),
		(22, 'Krasnogor', 'Natalie', ' '),
		(23, 'Cullinane', 'Dave', ' '),
		(24, 'Pooley', 'Rob', ' '),
		(25, 'Glassey', 'Jarka', ' '),
