...
public class AttributeDictionary {
	...
	public static final String LOGIN = "credentials";
	
	public static final String LITERATURE_LIST = "literaturelist";
	public static final String LITERATURE = "literature";
	public static final String LITERATURE_CATEGORY = "category";
